...
\author{\firstname{Luc} \lastname{Freyermuth}\inst{3}\fnsep\thanks{\email{luc.alexandre.freyermuth@cern.ch}} \and
        \firstname{Dmitri} \lastname{Konstantinov}\inst{1}\fnsep\thanks{\email{Dmitri.Konstantinov@cern.ch}} \and
