...
\author{\firstname{Luc}~\lastname{Freyermuth}\inst{1} \and
        ...
        \firstname{Ivan}~\lastname{Razumov}\inst{2,3}%\fnsep\thanks{\email{Ivan.Razumov@cern.ch}} \and
        \firstname{Witold}~\lastname{Pokorski}\inst{3}%\fnsep\thanks{\email{Witold.Pokorski@cern.ch}} \and
